    ...
    const SolidBackgroundEditor = () => {
        ...
        { const currentColorIndex = colorBarColors.findIndex((color)=>color===colorCombo);
            return(
                    ...
                    //     <Image style ={{width:'10%',height:'15%'}} source = {require('../../../assets/download.png')}/>
                    // </View>
                    <TouchableOpacity 
                        onPress={()=> {setColorIndex(currentColorIndex);setBackgroundType('solid');setSolidBackground(colorCombo.primaryColor);console.log(colorIndex)}}
        ...
        const secondaryColorBar = colorBarColors.map((colorCombo)=> 
        {
            ...
            return( 
                <View key={colorBarColors.indexOf(colorCombo)} 
                      style={{display: colorIndex===currentColorIndex?'flex':'none',flex:1,flexDirection:'column',alignSelf:'center',height:'100%',width:'93%'}}>
                    <View style={{flex:1,flexDirection:'row',height:'30%',width:'100%',padding:'1%'}}>
                        <TouchableOpacity 
                            onPress={()=> { setSolidBackground(colorCombo.secondaryColors[0]);setCurrentSecondaryColor(colorCombo.secondaryColors[0])}}
                            style={[{ margin: '2%',width:'28%',backgroundColor:colorCombo.secondaryColors[0]},styles.secondaryColor]}>
                        </TouchableOpacity>
                        <TouchableOpacity 
                            onPress={()=> { setSolidBackground(colorCombo.secondaryColors[1]);setCurrentSecondaryColor(colorCombo.secondaryColors[1])}}
                            style={[{margin: '2%',width:'28%',backgroundColor:colorCombo.secondaryColors[1]},styles.secondaryColor]}>
                        </TouchableOpacity> 
                        <TouchableOpacity 
                            onPress={()=> { setSolidBackground(colorCombo.secondaryColors[2]);setCurrentSecondaryColor(colorCombo.secondaryColors[2])}}
                            style={[{margin: '2%',width:'28%',backgroundColor:colorCombo.secondaryColors[2]},styles.secondaryColor]}>
                        </TouchableOpacity>
                    </View>
                    <View style={{flex:1,flexDirection:'row'}}>
                        <TouchableOpacity 
                            onPress={()=> { setSolidBackground(colorCombo.secondaryColors[3]);setCurrentSecondaryColor(colorCombo.secondaryColors[3])}}
                            style={[{margin: '2%',width:'28%',backgroundColor:colorCombo.secondaryColors[3]},styles.secondaryColor]}>
                        </TouchableOpacity>
                        <TouchableOpacity 
                            onPress={()=> { setSolidBackground(colorCombo.secondaryColors[4]);setCurrentSecondaryColor(colorCombo.secondaryColors[4])}}
                            style={[{margin: '2%',width:'28%',backgroundColor:colorCombo.secondaryColors[4]},styles.secondaryColor]}>
                        </TouchableOpacity>
                        <TouchableOpacity 
                            onPress={()=> { setSolidBackground(colorCombo.secondaryColors[5]);setCurrentSecondaryColor(colorCombo.secondaryColors[5])}}
                            style={[{margin: '2%',width:'28%',backgroundColor:colorCombo.secondaryColors[5]},styles.secondaryColor]}>
                        </TouchableOpacity>
                    </View>
                </View>
        );}
